...
type RestaurantBrandId = "brand_fryguy" | "brand_tarini";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="inline-flex p-1 bg-stone-100 rounded-xl border border-stone-200">
              ...
              <button
                type="button"
                id="brand-menu-toggle-tarini"
                onClick={() => handleSwitchBrand("brand_tarini")}
                className={`px-3.5 py-1.5 rounded-lg text-xs font-bold transition-all ${
                  activeBrandId === "brand_tarini"
